      ...
      {!true ? (
        <View>
          <View className="flex flex-row justify-end items-end m-8">
            <TouchableOpacity className="bg-gray-300 flex flex-row justify-center items-center rounded-2xl gap-2 pb-2 px-2 ">
              <Image
                source={icons.plus2}
                className="w-4 h-4"
                resizeMode="cover"
        ...
        <View className="w-full h-full flex justify-center items-center ">
          ...
          <View className="flex justify-center gap-4 ">
            ...
            <TouchableOpacity className="px-4 py-2 rounded-xl bg-blue-300	">
